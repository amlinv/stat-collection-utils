...
/**
 * Test the DefaultJmxServiceUrlFactory: this test is intended to show line coverage and is not intended as a true
 * functional test since the implementation is a simple pass-through to a static method call.
 *
 * Created by art on 8/18/15.
 */
public class DefaultJmxServiceUrlFactoryTest {
    ...
    public void testCreateJMXServiceUrl() throws Exception {
        ...
        result = factory.createJMXServiceUrl("service:jmx:rmi://127.0.0.1:1099/jndi/rmi://127.0.0.1:1099/jmxrmi");
